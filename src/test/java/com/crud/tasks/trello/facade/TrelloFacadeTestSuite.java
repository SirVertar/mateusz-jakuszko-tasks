...
public class TrelloFacadeTestSuite {
    ...
    public void shouldFetchTrelloBoards() {
        ...
        List<TrelloBoardDto> trelloBoardDtoList = new ArrayList<>();
        trelloBoardDtoList.add(new TrelloBoardDto("1", "my_task", trelloListDtos));
    ...
    public void shouldCreateCardTest() {
        //Given
        TrelloCardDto trelloCardDto = new TrelloCardDto("Card", "Test card description",
                "12", "3");
        TrelloCard trelloCard = new TrelloCard("Card", "Test card description",
                "12", "3");
        CreatedTrelloCardDto createdTrelloCardDto = new CreatedTrelloCardDto("3", "Created card",
                "url");
        ...
        //When
        CreatedTrelloCardDto createdTrelloCardDtoByFacade = trelloFacade.createCard(trelloCardDto);

        //Then
        assertEquals("3", createdTrelloCardDtoByFacade.getId());
        assertEquals("Created card", createdTrelloCardDtoByFacade.getName());
        assertEquals("url", createdTrelloCardDtoByFacade.getShortUrl());
